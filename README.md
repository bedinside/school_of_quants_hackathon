...
1) Участникам необходимо обучить модель на основе фичей из X_train и лейблов (правильных ответов) из y_train
2) На основе X_test участники делают предсказание значений y_test (скрыт от участников) с помощью обученных моделей
3) Полученные и загруженные предсказания участников сравниваются с настоящим файлом y_test, высчитывается метрика качества
...
– next_payment_sum - **Сумма следующего платежа по кредиту** 
– sum_left_to_pay - **Оставшаяся невыплаченная сумма кредита** 
– current_overdue_debt - **Текущая просроченная задолженность** 
– max_overdue_debt - **Максимальная просроченная задолженность** 
– full_credit_cost - **Полная стоимость кредита** 
